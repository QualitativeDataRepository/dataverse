...
@NamedQueries({
   ...
   @NamedQuery( name  = "RoleAssignment.listByAssigneeIdentifiers_NoDefPoint",
       query = "SELECT r FROM RoleAssignment r WHERE r.assigneeIdentifier in :assigneeIdentifiers" ),
